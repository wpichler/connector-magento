odoo.define('connector_magento_dashboard.ConnectorMagentoDashboardView', function (require) {
    "use strict";
    ...
    var ConnectorMagentoDashboardView = KanbanView.extend({
        ...
        fetch_data: function() {
            return new BasicModel('magento.backend')
        ...
        on_change_input_target: function(e) {
            ...
            if(isNaN(target_value)) {
                ...
                this._updated = new BasicModel('crm.lead')
